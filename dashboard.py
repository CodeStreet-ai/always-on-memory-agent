...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown("<p style='text-align: center; color: #93c5fd; font-size: 12px; font-weight: 600;'>OpenAI Agents SDK</p>", unsafe_allow_html=True)
    ...
    st.markdown(
          ...
          <p style="color: #666; font-size: 14px; max-width: 600px; margin: 0 auto;">
            ...
            Built with <strong style="color: #93c5fd;">OpenAI Agents SDK</strong> + <strong style="color: #c4b5fd;">GPT-4o mini</strong>.
